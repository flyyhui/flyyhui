...
合成复用原则（Composite Reuse Principle）尽量使用 **合成/聚合** 的方式，而不是使用继承。

> 继承图

B 直接继承 A

![image-20220226103414310](D:\软件区\工具区\Typora\图片\image-20220226103414310.png)

> 聚合图

B 需要 A 的三个方法，但不是继承，而是通过方法参数、构造器、setter 传入 A 的对象

![image-20220226103435911](D:\软件区\工具区\Typora\图片\image-20220226103435911.png)

> 组合图

B 需要 A 的三个方法，直接通过 `new A` 获得 A 的对象

![image-20220226103439980](D:\软件区\工具区\Typora\图片\image-20220226103439980.png)
